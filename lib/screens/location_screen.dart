            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  FlatButton(
                    onPressed: () async {
                      Map data = await weather.getLocationWeather();
                      updateData(data);
                    },
                    child: Icon(
                      Icons.near_me,
                  ...
                  FlatButton(
                    onPressed: () async {
                      ...
                      print(r);
                      if (r != null) {
                        Map data = await weather.getCityWeather(r);
                        updateData(data);
                      }
                    },
                    child: Icon(
              ...
              Padding(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Text(
                      weather.getWeatherIcon(int.parse(condition)),
              ...
              Padding(
                ...
                child: Text(
                  "${weather.getMessage(double.parse(temp))} in $city!",
